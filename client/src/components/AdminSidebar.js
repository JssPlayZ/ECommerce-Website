    ...
    return (
        <div className="w-64 bg-slate-800 flex-col p-4 hidden md:flex">
            ...
            <nav className="flex flex-col gap-2">
                ...
                <NavLink to="/admin/importer" className={linkClass}>
                     <svg xmlns="http://www.w.3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>
                    Product Importer
                </NavLink>
